...
//    val database: MongoDatabase = MongoDB.client.getDatabase(Settings.MONGO_DATABASE_NAME)
//    val collection = database.getCollection(Settings.MONGO_COLLECTION_NAME)
...
//
//  val client: MongoClient = MongoClient(Settings.MONGO_URI)
//
